...
function Swap(props) {
  ...
  // console.log(
  //   "localStorage.getItem(torus)",
  //   JSON.parse(localStorage.getItem("torus"))
  // );
                                  ...
                                  >
                                    <AccordionSummary
                                      expandIcon={
                                        <CardHeader
                                          style={{ margin: "10px" }}
                                          title={numeral(tokenAAmount).format(
                                            "0,0.000000000"
                                          )}
                                        />
                                      }
                                  ...
                                  >
                                    <AccordionSummary
                                      expandIcon={
                                        <CardHeader
                                          style={{ margin: "10px" }}
                                          title={numeral(tokenBAmount).format(
                                            "0,0.000000000"
                                          )}
                                        />
                                      }
