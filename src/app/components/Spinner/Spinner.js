        ...
        <g id="spinner2">
          <g id="outer" style={{ animationDuration: props.speed + "s" }}>
            <circle
              ...
              strokeWidth="11"
            />
            <circle id="Ellipse 2" cx="124" cy="20" r="20" fill="#113CFC" />
            <circle id="Ellipse 5" cx="124" cy="227" r="20" fill="#113CFC" />
            <circle id="Ellipse 3" cx="228" cy="127" r="20" fill="#113CFC" />
            <circle id="Ellipse 4" cx="20" cy="127" r="20" fill="#113CFC" />
          </g>
