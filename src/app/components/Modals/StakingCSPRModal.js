...
function StakingCSPRModal(props) {
  ...
  const [addyOpen, setAddyOpen] = React.useState(false);
                ...
                <div className="col-md-12 col-lg-6">
                  ...
                  <div className="row">
                    ...
                    <div className="col-md-12 col-lg-4">
                      <FormControl fullWidth sx={{ m: 1 }}>
                        <InputLabel id="demo-controlled-open-select-label">CSPR</InputLabel>
                        <Select
                  ...
                  <div className="row">
                    ...
                    <div className="col-md-12 col-lg-4">
                      <FormControl fullWidth sx={{ m: 1 }}>
                        <InputLabel id="demo-controlled-open-select-label">Addy</InputLabel>
                        <Select
                          labelId="demo-controlled-open-select-label"
                          id="demo-controlled-open-select"
                          open={addyOpen}
                        ...
                        >
                          ...
                          <MenuItem value={"Wise Team Referral"}>Wise Team Referral</MenuItem>
                          <MenuItem value={"Cookie Reffral Addy"}>Cookie Reffral Addy</MenuItem>
                        </Select>
                      </FormControl>
                    </div>
                  </div>
