    ...
    return (
        <Grid item xs={12} sm={6} md={6} >
            <Card style={{ height: "100%" }} variant="outlined">
                ...
                />
                <CardMedia
                    variant="outlined" style={{ border: props.data.type === "Mastercraft" ? '4px solid #6476bf' : props.data.type === "Legendary" ? '4px solid #FFD700' : props.data.type === "Epic" ? '4px solid #9400D3' : props.data.type === "Rare" ? '4px solid #0000FF' : props.data.type === "Uncommon" ? '4px solid #008000' : props.data.type === "Common" ? '4px solid #FFFFFF' : 'none' }}
